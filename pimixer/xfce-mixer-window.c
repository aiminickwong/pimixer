                                          ...
                                          XfceMixerWindow *window)
{
  ...
  system ("lxpanelctl command volumealsabt start");
}
...
void xfce_mixer_window_refresh_device (XfceMixerWindow *window)
{
  ...
  else xfce_mixer_card_combo_update (XFCE_MIXER_CARD_COMBO (window->soundcard_combo), xfce_mixer_window_get_active_card (window));
